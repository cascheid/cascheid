...
<body>
	...
	<script>
		...
		document.getElementById("accelDisplay").style.background='linear-gradient(to right, royalblue 0%, royalblue ${raceCar.acceleration}%, lightgreen ${raceCar.acceleration}%, lightgreen ${raceCar.acceleration+upgrade.accelerationMod}%, white ${raceCar.acceleration+upgrade.accelerationMod}%, white 100%)';
